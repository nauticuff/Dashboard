const MainDash = () => {
    return (
        <div className="flex justify-between gap-8 flex-wrap">
            <div className="flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex gap-2 py-8 items-center">
                    ...
                    <p className="font-bold text-[var(--l-text-light)]">@nathanf</p>
                </div>
                <h2>1987</h2>
                <p className="tracking-[.35em] uppercase text-[var(--l-text-light)]">Followers</p>
                <div className="flex items-center gap-1 py-8">
                    ...
                    <p className="font-bold text-[var(--green)]">12 Today</p>
                </div>
            </div>
            <div className="flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex items-center gap-1 py-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                    <p className="font-bold text-[var(--green)]">99 Today</p>
                </div>
            </div>
            <div className="flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex gap-2 py-8 items-center">
                    ...
                    <p className="font-bold text-[var(--l-text-light)]">@realnathanf</p>
                </div>
                <h2>11k</h2>
                <p className="tracking-[.35em] uppercase text-[var(--l-text-light)]">Followers</p>
                <div className="flex items-center gap-1 py-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                    <p className="font-bold text-[var(--green)]">1099 Today</p>
                </div>
            </div>
            <div className="flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex gap-2 py-8 items-center">
                    ...
                    <p className="font-bold text-[var(--l-text-light)]">Nathan F.</p>
                </div>
                <h2>8239</h2>
                <p className="tracking-[.35em] uppercase text-[var(--l-text-light)]">Subscribers</p>
                <div className="flex items-center gap-1 py-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fillRule="evenodd" d="M0 0l4 4 4-4z" /></svg>
                    <p className="font-bold text-[var(--red)]">144 Today</p>
                </div>
            </div>
        </div>
    );
