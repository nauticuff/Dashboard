        ...
        <div className="cards flex justify-between gap-8 flex-wrap">
            <div className="card flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex items-center gap-1 py-8">
                    ...
                    <p style={{color: "var(--green)"}} className="font-bold">12 Today</p>
                </div>
            </div>
            <div className="card flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex items-center gap-1 py-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                    <p style={{color: "var(--green)"}} className="font-bold">99 Today</p>
                </div>
            </div>
            <div className="card flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex items-center gap-1 py-8">
                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                    <p style={{color: "var(--green)"}} className="font-bold">1099 Today</p>
                </div>
            </div>
            <div className="card flex w-full sm:w-[47%] lg:w-[22.5%] flex-col items-center bg-[var(--l-card-bg)] px-8 rounded-lg overflow-hidden relative cursor-pointer">
                ...
                <div className="flex items-center gap-1 py-8">
                    ...
                    <p style={{color: "var(--red)"}} className="font-bold">144 Today</p>
                </div>
            </div>
        </div>
    );
