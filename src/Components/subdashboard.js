    ...
    return (
        <div>
            ...
            <div className="flex justify-between flex-wrap gap-y-8">
                <div className="relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        <div className="flex justify-between items-center gap-2">
                            <p className="font-bold text-[var(--l-text-light)]">Page Views</p>
                        ...
                        <div className="flex items-baseline justify-between">
                            ...
                            <div className="relative font-bold">
                                <p className="text-[var(--green)]">3%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>52</h1>
                            <div className="relative font-bold">
                                <p className="text-[var(--red)]">2%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fill-rule="evenodd" d="M0 0l4 4 4-4z" /></svg>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>5462</h1>
                            <div className="relative font-bold">
                                <p className="text-[var(--green)]">2257%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                            </div>
                        </div>
                    </div>
                ...
                <div className="relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>52k</h1>
                            <div className="relative font-bold">
                                <p className="text-[var(--green)]">1375%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                            </div>
                        </div>
                    </div>
                ...
                <div className="relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>117</h1>
                            <div className="relative font-bold">
                                <p className="text-[var(--green)]">303%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                            </div>
                        </div>
                    </div>
                ...
                <div className="relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>507</h1>
                            <div className="relative font-bold">
                                <p className="text-[var(--green)]">553%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                            </div>
                        </div>
                    </div>
