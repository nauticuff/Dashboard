                ...
                <div className="card cursor-pointer relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>52</h1>
                            <div className="relative font-bold">
                                <p style={{color: "var(--red)"}}>2%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#DC414C" fillRule="evenodd" d="M0 0l4 4 4-4z" /></svg>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="card cursor-pointer relative overflow-hidden p-8 w-full sm:w-[47%] lg:w-[22.5%] bg-[var(--l-card-bg)] rounded-lg">
                    <div className="flex flex-col justify-center w-full gap-y-3">
                        ...
                        <div className="flex items-baseline justify-between">
                            <h1>5462</h1>
                            <div className="relative font-bold">
                                <p style={{color: "var(--green)"}}>2257%</p>
                                <svg className="absolute top-1/2 -translate-x-[.6rem] -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="8" height="4"><path fill="#1EB589" fillRule="evenodd" d="M0 4l4-4 4 4z" /></svg>
                            </div>
                        </div>
                    </div>
